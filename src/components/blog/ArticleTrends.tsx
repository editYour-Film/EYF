      ...
      <div className="relative flex flex-col justify-between items-center gap-dashboard-spacing-element-medium z-20">
        <div className="flex flex-col px-[8px] md:px-0  w-full max-w-[580px] items-center gap-dashboard-spacing-element-medium">
          <div className="flex flex-col items-center gap-dashboard-specific-radius">
            <div className="text-center text-title-medium transition-color duration-300 text-dashboard-text-description-base group-focus-visible:text-dashboard-text-title-white-high group-hover:text-dashboard-text-title-white-high">
              {article.attributes.title}
            </div>

            <CategoryBadge
              className="opacity-50 transition-opacity duration-300 group-focus-visible:opacity-100 group-hover:opacity-80"
              category={
