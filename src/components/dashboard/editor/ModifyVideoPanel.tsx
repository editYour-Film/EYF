                ...
                <div className="flex w-full md:flex-col overflow-scroll md:overflow-visible  gap-dashboard-mention-padding-right-left no-scroll-bar">
                  ...
                  <div className="relative">
                    <ToolboxButton
                      Icon={Lock}
                      label={
                        editorContext.modelVisibility
                          ? editorContext.modelVisibility.length > 20
                            ? editorContext.modelVisibility.slice(0, 16) + "..."
                            : editorContext.modelVisibility
                    ...
                    {!isMobile && (
                      <DropBox
                        ...
                        title="Visibilité"
                        choices={Visibility}
                        currentValue={editorContext.modelVisibility}
                        onChange={(val) => {
                          if (val) {
                            editorContext.setModelVisibility(val);
                            editorContext.setCurrentModelToModify(
                              (previousState: EditorVideo) => ({
                                ...previousState,
                                visibility: val,
