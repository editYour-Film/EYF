...
export const EndPan = () => {
  ...
  const title = context.isModify
    ? "Vos modifications ont bien été prise en compte"
    : "Votre modèle est en cours de vérification par nos équipes !";
  const content = context.isModify
    ? "Cliquez sur le bouton pour revenir à votre dashboard"
    : "Vos vidéos resteront privées jusqu’à leur publication.  Chaque modèle est vérifié avant d’être publié dans le catalogue.";
