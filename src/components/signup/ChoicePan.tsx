...
export const ChoicePan = () => {
  ...
  const handleNextPan = () => {
    context.handleStart();
    if (context.accountType) context.goNext();
  };
    ...
    <div className="choice-pan w-[421px] max-w-[100vw]">
      <SignInSignUpContainer ref={container}>
        ...
        <div className="w-full flex flex-col gap-dashboard-spacing-element-medium px-dashboard-specific-radius md:px-0">
          ...
          <div className="text-center shadow-text text-large font-medium">
            Bienvenue sur editYour.Film
          </div>
        ...
        <SimpleCard className="text-center flex flex-col gap-dashboard-spacing-element-medium">
          <div>
            ...
            <div className="text-dashboard-text-description-base mt-dashboard-mention-padding-right-left">
              editYour.Film vous aide à créer efficacement, que vous soyez
              créateur.se, monteur.se, ou les deux. Rejoignez-nous pour trouver
              le monteur qu'il vous faut ou proposer vos services.
            </div>
          </div>
        ...
        <div className="text-center text-dashboard-text-description-base-low px-dashboard-specific-radius md:px-0">
          {context.disclaimer}
        </div>
