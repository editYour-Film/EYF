...
export const Dropdown = ({label, onChange, options, selected, className = ''}: DropdownProps) => {  
  ...
  return (
    ...
    >
      ...
      <div 
        ref={dropdownOptions}
        className={`absolute dropdown__options-w w-[calc(100%+2px)] overflow-hidden top-5 z-10 box-border ${!isOpen && 'pointer-events-none'}`}
      >
        <div 
          ref={dropdownOptionsInner}
          className={`dropdown__options-inner w-full bg-black p-4 rounded-b-xl border-x border-b ${enableSearch && 'border-white'} pt-6`}
        >
          <hr className="mb-4"/>
