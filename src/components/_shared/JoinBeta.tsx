...
export const JoinBeta = ({ isVisible = false, onClose }: JoinBetaProps) => {
  ...
  return <div className={`joinBeta fixed top-0 left-0 w-full h-[100vh] min-h-[100vh] bg-blackBerry flex flex-col lg:flex-row justify-start lg:justify-around items-center gap-10 lg:gap-12 xl:gap-24 fullHd:gap-10 fullHd:justify-center transition-transform duration-700 ease-in-out z-popup overflow-scroll lg:overflow-hidden ${isVisible ? 'translate-y-0 pointer-events-all' : 'translate-y-[130%] pointer-events-none'}`}>
    ...
    <div className="joinBeta__text flex flex-col gap-6 mt-16 md:mt-32 px-10 md:px-16 basis-[100%] lg:mt-0 lg:pr-0 lg:pl-28 lg:basis-[568px] lg:shrink-0 fullHd:pl-0">
      <Image
        ...
        height="71"
      />
      <div className="joinBeta__title n27 text-title-large leading-[110%]">DEMANDER À<br/>REJOINDRE<br/>LA BETA</div>
    ...
    <div className="joinBeta__form px-10 md:px-16 lg:px-32 py-24 z-10 bg-blackBerry rounded-[24px]">
      <form 
        id="sb_form"
        ref={joinBetaForm} 
      ...
      >
        <div className="flex flex-col">
          <label 
            ...
            className="text-soyMilk opacity-70 mb-2">Prénom</label>
          <input
            type="text"
            sb-form-input="true"
        ...
        <div className="flex flex-col">
          <label 
            id="label-email"
            htmlFor="joinBeta__email" className="text-soyMilk opacity-70 mb-2">Email</label>
          <input
            type="text"
            sb-form-input="true"
            id="input-email"
        ...
        <div className="flex flex-row items-start gap-3">
          ...
          />
          <label htmlFor="joinBeta__checkbox" className="text-soyMilk opacity-40">J’accepte que EditYour.Film et Sarbacane traitent mes informations personnelles à des fins commerciales, telles que définies dans notre Politique de confidentialité et les CGU de EditYour.Film.</label>
        </div>
