...
const Footer = () => {
  ...
  const linksTitleClass = "text-base text-dashboard-text-title-white-high mt-8 md:mt-0";
  const linksClass = "text-base text-dashboard-text-description-base opacity-70 transition-opacity duration-100 hover:opacity-100 py-[10px]";
          ...
          <div className="md:col-span-3 rounded-3xl p-2 md:py-[20px]">
            ...
            <div className="group flex flex-wrap gap-1 sm:gap-2 md:gap-4 mt-5">
              <a
                ...
                rel="noopener"
              >
                <FbIcon className={'w-[35px] h-[35px] svg-color-dashboard-text-description-base hover:svg-color-blueBerry transition-colors duration-500'}/>
              </a>
              ...
              <a
                ...
                rel="noopener"
              >
                <InstaIcon className={'w-[35px] h-[35px] svg-color-dashboard-text-description-base hover:svg-color-blueBerry transition-colors duration-500'}/>
              </a>
              ...
              <a
                ...
                rel="noopener"
              >
                <LnkdnIcon className={'w-[35px] h-[35px] svg-color-dashboard-text-description-base hover:svg-color-blueBerry transition-colors duration-500'}/>
              </a>
              ...
              >
                <TwtIcon className={'w-[35px] h-[35px] svg-color-dashboard-text-description-base hover:svg-color-blueBerry transition-colors duration-500'}/>
              </a>
            </div>
          </div>
