...
export const ComparativeSection = ({ data }: ComparativeSectionProps) => {
  ...
  const cards = useRef<RefObject<HTMLDivElement>[]>(
    data.comparison_cards.map(() => createRef())
  );
  ...
  useEffect(() => {
    ...
    let tl: GSAPTimeline,
      st: globalThis.ScrollTrigger,
      st2: globalThis.ScrollTrigger;
    ...
    if (ww && ww.width && ww.width > 1024) {
      ...
      st = ScrollTrigger.create({
        ...
        start: `top top`,
          ...
          section.current && wrapper.current
...
const Card = forwardRef<HTMLDivElement, CardProps>(function Card(
  ...
  return (
    ...
    >
      <div className="comparative-card__inner h-full relative z-20 flex flex-col md:items-center">
        {supTitle && (
          <div className="comparative-card__title text-title-small text-dashboard-text-description-base-low md:text-center leading-none mb-dashboard-button-separation-spacing">
            {supTitle}
          </div>
        )}

        {title && (
          <div className="comparative-card__title text-title-medium text-dashboard-text-description-base md:text-center">
            {title}
          </div>
        )}
            ...
            details.map((detail, i) => {
              return (
                ...
                >
                  ...
                  <div className="lg:text-center text-dashboard-text-description-base text-medium">
                    {detail.entry}
                  </div>
                </div>
              );
